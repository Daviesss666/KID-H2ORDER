...
<head>
    ...
    <title>Alpha Lab Test Result</title>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Alpha Lab Test Reports</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Renewed/To Renew</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <table id="table" class="table user-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">EXPIRED ON</th>                                            
                                                <th class="border-top-0">STATUS</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                              <?php  
                                                   $query = $conn->query("SELECT max(inspection.date) as max, inspection.inspection_id, merchant.business_name,merchant.contact_number,
                                                          inspection.date,inspection.status, admin.inspection_date, merchant.business_name
                                                 FROM merchant
                                                 RIGHT JOIN inspection ON merchant.merchant_id = inspection.merchant_id 
                                                 RIGHT JOIN admin ON admin.admin_id = inspection.admin_id 
                                                 
                                                 GROUP BY merchant.merchant_id ORDER BY date ASC
                                                 ") or die(mysqli_error());
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo date("M d, Y", strtotime($fetch['max']))?></td>
                                                <td> 
                                                     <?php 
                                                           $startdate = $fetch['max'] ;
                                                           echo date('M d, Y', strtotime($startdate. ' + 6 months'));
                                                            ?>
                                                ...
                                                <td>
                                                        <?php 
                                                            $date1 = $fetch['max'];
                                                            $date2= $fetch['date'];
                                                            $date3= strtotime($date1. ' + 6 months');
                                                            $date4= strtotime(date("Y-m-d"));
                                                            if($date4 < $date3 ){
                                                                echo "Renewed";
                                                            }else{
                                                                echo "To Renew";
