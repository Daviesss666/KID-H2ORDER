...
<button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#Ins_date"
 style="margin-left: 20px; margin-bottom: 20px; color: white;">
  Set Inspection Date
</button>
        ...
        <form action ="add_query_inspection.php?admin_id=<?php echo $fetch['admin_id']?>" method = "POST"  enctype="multipart/form-data">
           ...
           <input type="hidden" value="<?php echo $fetch['admin_id']?>" name="admin_id">
            ...
            <div id="date-picker-example" class="md-form md-outline input-with-post-icon datepicker" inline="true">
              <input type="date" name="inspection_date" value="<?php echo $fetch['inspection_date']?>" required = "required"  class="form-control">
            </div>
            ...
            <br />
            <div class = "form-group">
              <button name = "add_inspection_date" class = "btn btn-info form-control" style="background:dodgerBlue;"><i class = ""></i> Saved</button>
            </div>
            <?php require_once 'add_query_inspection.php'?>
          </form>
        </div>
