            ...
            <h5 class="font-weight-bold">Price</h5>
                ...
                <form class="brand">
                    <div class="form-inline d-flex align-items-center py-1"> 
                        ...
                        <?php
                            $select_sql = "SELECT price FROM product
                        ...
                        <?php
                            $select_sql2 = "SELECT price FROM product
                          ...
                          <?php
                            $select_sql3 = "SELECT price FROM product
                          ...
                          <?php
                            $select_sql4 = "SELECT price FROM product
                          ...
                          <?php
                            $select_sql5 = "SELECT price FROM product
                        ...
                        while ($data = $result->fetch_assoc()) {
                            ...
                            $merchantId = $data['merchant_id'];
                             /*$query3 = $conn->query("SELECT inspection.inspection_id, inspection.date, 
                               ...
                               $query3 = $conn->query("SELECT inspection.inspection_id, inspection.date, admin.inspection_date,
                                                inspection.date,inspection.status,inspection.merchant_id
                                                FROM inspection
