          ...
          <div class="card-body">
           ...
           <!--  <div class="d-flex justify-content-between mb-2">
            ...
            <div class="d-flex justify-content-between mb-3">
             ...
             <h5 style="float:left" class="mb-0">Quantity: </h5>

             <div style="margin-right:20%" class="d-flex justify-content-center mb-3">
                    <button type="button" class=" btn-link px-2" style="background:white; border: none;"
                      onclick="this.parentNode.querySelector('input[type=number]').stepDown()">
                      <i class="fas fa-minus"></i>
                    </button>

                    <input id="number" min="1" max="50" maxlength="2" name="number_of_items" value="1" type="number" 
           ...
           <!--<center><br>Enter Quantity:<br><span style="font-size:100%;color:#CCCC00;margin:20px">
            ...
            <center><button id="Acart" type="submit" name="submit" onclick="addcart();" class="btn btn-primary btn-lg ">
