        ...
        <div class="card text-black" style="border-radius: 25px;">
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1" translate="no">
...
<div class="modal" id="myModal">
  <div class="modal-dialog" translate="yes">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
            <h4 class="modal-title" style="margin-top:20px">Terms and Conditions &nbsp<i class="fa fa-pencil-square-o" style="font-size: 1em;"></i></h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>

      <!-- Modal body -->
      <div class="modal-body"> <div id="google_translate_element"></div>
         ...
         <h5 style="margin-top:20px">Private Policy</h5>
          ...
          <h5 style="margin-top:20px">2. Hygiene and Refills</h5>
            ...
            <p  style="font-size:14px;">
              &#10148; The User will keep their water container as clean as possible to avoid any chances of infection or illnesses.
            </p>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="submit" id= submit_button disabled name="submit" class="btn btn-primary btn-md">Sign Up</button>
                  </div>
...
<script src="../js/translate.js" crossorigin="anonymous"></script>                 
