...
<html>
    ...
    <body style="background-color: white">
      ...
      <div class="container">
        <?php
            $query = $conn->query("SELECT product.product_id,product.image,product.product_name,product.product_type,product.volume,
            product.price, product.merchant_id,orderlist.status, orderlist.order_id,orderlist.quantity,
            ...
            ,customer.firstname, customer.lastname, customer.address as C_add, customer.contact_number,customer.customer_id,customer.barangay ,customer.email,customer.address
            FROM `orderlist`
            RIGHT JOIN product ON orderlist.product_id = product.product_id
            RIGHT JOIN merchant ON orderlist.merchant_id = merchant.merchant_id
            RIGHT JOIN customer ON orderlist.customer_id = customer.customer_id
