...
<html>
  ...
  <tbody>
<?php
 $queryy = $conn->query("SELECT product.product_id,product.image,product.product_name,product.product_type,product.volume,
      ...
      orderlist.date, customer.firstname, customer.lastname, customer.customer_id,customer.address,customer.barangay,customer.email,customer.contact_number
      FROM orderlist 
...
?>
  <form action="action.php" method="POST" enctype="multipart/form-data" > 
         <input type="hidden" value="<?php echo $fetch['product_id']?>" name="product_id">
          <input type="hidden" value="<?php echo $fetch['product_name']?>" name="product_name">
      ...
      <td class="align-middle">
        <div>
                     ...
                     <div class="select-container" style="margin-top:-10px">
                          <select class="form-select form-select-sm" name="deliveryman_<?php echo $fetch['order_id']?>" aria-label="Default select example" id="sel">
                          <?php
